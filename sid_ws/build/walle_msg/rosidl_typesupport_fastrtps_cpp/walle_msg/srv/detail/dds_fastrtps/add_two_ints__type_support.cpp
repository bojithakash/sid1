...
#include "walle_msg/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = walle_msg::srv::AddTwoInts_Request;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const walle_msg::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<walle_msg::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &walle_msg::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = walle_msg::srv::AddTwoInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const walle_msg::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<walle_msg::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &walle_msg::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &walle_msg::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
