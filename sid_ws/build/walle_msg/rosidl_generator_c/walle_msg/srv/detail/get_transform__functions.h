...
#ifndef WALLE_MSG__SRV__DETAIL__GET_TRANSFORM__FUNCTIONS_H_
#define WALLE_MSG__SRV__DETAIL__GET_TRANSFORM__FUNCTIONS_H_
...
#include "walle_msg/msg/rosidl_generator_c__visibility_control.h"
 ...
 */
ROSIDL_GENERATOR_C_PUBLIC_walle_msg
bool
 ...
 * calls
 * walle_msg__srv__GetTransform_Request__init().
...
/**
 * It calls
 * walle_msg__srv__GetTransform_Request__fini()
 ...
 * walle_msg__srv__GetTransform_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * walle_msg__srv__GetTransform_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * walle_msg__srv__GetTransform_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_walle_msg
...
/**
 * It calls
 * walle_msg__srv__GetTransform_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_walle_msg
...
/**
 * It allocates the memory for the array and calls
 * walle_msg__srv__GetTransform_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_walle_msg
...
/**
 * It calls
 * walle_msg__srv__GetTransform_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // WALLE_MSG__SRV__DETAIL__GET_TRANSFORM__FUNCTIONS_H_
